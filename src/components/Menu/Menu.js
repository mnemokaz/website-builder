  ...
  return (
    <form className={styles.container}>
      ...
      <div
        ...
        onClick={() => dispatch(appSlice.actions.changeTypeAction('landing'))}>
      ...
      <div
        className={styles.button}
        onClick={() => dispatch(appSlice.actions.changeTypeAction('blog'))}>
      ...
      <div
        className={styles.button}
        onClick={() => dispatch(appSlice.actions.changeTypeAction('shop'))}>
